...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-white p-6 max-w-2xl mx-auto">
      ...
      <p className="text-sm text-slate-500 mb-6">Last updated: February 2, 2026</p>
      ...
      <div className="prose prose-slate prose-sm">
        ...
        <section className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
          <h2 className="text-lg font-semibold text-slate-900 mb-2">Apple Health Integration</h2>

          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">Health Data We Access</h3>
          ...
          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">How We Use Your Health Data</h3>
          <p className="text-slate-600 mb-2">Your Apple Health data is used exclusively to:</p>
          <ul className="list-disc list-inside text-slate-600 space-y-1 mb-4">
          ...
          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">Health Data Protection</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">Your Control Over Health Data</h3>
          <p className="text-slate-600 mb-4">
        ...
        <section className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
          <h2 className="text-lg font-semibold text-slate-900 mb-2">Other Health Integrations</h2>

          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">Oura Ring</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-md font-medium text-slate-800 mt-4 mb-2">Eight Sleep</h3>
          <p className="text-slate-600 mb-4">
        ...
        <section className="mb-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-2">Data Storage &amp; Security</h2>
          <p className="text-slate-600 mb-4">
