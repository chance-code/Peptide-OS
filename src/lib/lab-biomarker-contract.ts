...
export const BIOMARKER_REGISTRY: Record<string, BiomarkerDefinition> = {
  ...
  apolipoprotein_a1: {
    ...
    shortName: 'ApoA1',
    aliases: ['ApoA1', 'Apo A-1', 'Apolipoprotein A-1', 'ApoA-I', 'Apo A1'],
    category: 'lipids',
    unit: 'mg/dL',
    polarity: 'higher_better',
    optimalRange: { min: 150, optimal: 170, max: 200 },
    referenceRange: { min: 115, max: 220 },
    absoluteBounds: { min: 30, max: 400 },
    healthDomains: ['cardiovascular'],
    relatedMetrics: ['rhr', 'vo2_max'],
    biologicalVariation: { withinSubjectCV: 6.5, betweenSubjectCV: 13.6 },
    format: fmtMgDL,
  },
  apob_apoa_ratio: {
    key: 'apob_apoa_ratio',
    ...
    shortName: 'ApoB/A1',
    aliases: ['ApoB ApoA Ratio', 'ApoB/ApoA-I', 'ApoB ApoA1 Ratio'],
    category: 'lipids',
    unit: 'ratio',
    polarity: 'lower_better',
    optimalRange: { min: 0.2, optimal: 0.4, max: 0.6 },
    referenceRange: { min: 0, max: 0.9 },
    absoluteBounds: { min: 0, max: 3 },
    criticalHigh: 1.0,
    healthDomains: ['cardiovascular'],
    relatedMetrics: [],
  ...
  trig_hdl_ratio: {
    ...
    unit: 'ratio',
    polarity: 'lower_better',
    optimalRange: { min: 0.5, optimal: 1.0, max: 1.5 },
    referenceRange: { min: 0, max: 3.5 },
    absoluteBounds: { min: 0, max: 20 },
    criticalHigh: 6.0,
    healthDomains: ['cardiovascular', 'body_composition'],
    relatedMetrics: ['body_fat_percentage'],
    wearableCorrelations: [
      { metric: 'body_fat_percentage', relationship: 'direct', mechanism: 'Higher TG/HDL ratio correlates with visceral fat and insulin resistance' },
    ],
    format: (v) => v.toFixed(2),
  },
  homa_ir: {
  ...
  free_t3_rt3_ratio: {
    ...
    shortName: 'T3/rT3',
    aliases: ['T3 RT3 Ratio', 'FT3/RT3', 'Free T3 Reverse T3 Ratio'],
    category: 'hormones_thyroid',
    unit: 'ratio',
    polarity: 'higher_better',
    optimalRange: { min: 0.2, optimal: 0.3, max: 0.5 },
    referenceRange: { min: 0.1, max: 0.6 },
    absoluteBounds: { min: 0, max: 2 },
    healthDomains: ['energy', 'body_composition'],
    relatedMetrics: ['rhr', 'body_fat_percentage'],
